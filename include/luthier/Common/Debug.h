...
/// machinery directly by wrap debug-only code in
/// \c LLVM_DEBUG(...) from <tt>llvm/Support/Debug.h</tt>, keyed by a
/// per-file <tt>\#define DEBUG_TYPE "..."</tt>, and emit to \c luthier::dbgs()
