...
#ifndef LUTHIER_TOOL_CODE_GEN_IP_REG_SCAVENGER_H
#define LUTHIER_TOOL_CODE_GEN_IP_REG_SCAVENGER_H
...
public:
  ...
  llvm::Register scavengeRegisterBackwards(const llvm::TargetRegisterClass &RC,
...
private:
  ...
  bool isReserved(llvm::Register Reg) const { return MRI->isReserved(Reg); }
