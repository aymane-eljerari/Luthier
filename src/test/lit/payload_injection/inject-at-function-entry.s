// Verifies that the InstrumentationPMDriver, given a target HIP kernel and a
// pre-canonicalized IModule containing a single hook, can run the mock
// at-function-entry payload injection pass and write back an IModule
// containing one injected payload function that calls the hook.
//
...
// RUN:    -imodule-ir-passes=luthier-mock-inject-at-function-entry \
// RUN:    -o /dev/null && \
