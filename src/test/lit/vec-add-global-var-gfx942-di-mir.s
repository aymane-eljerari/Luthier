...
// CHECK: [[FILE:![0-9]+]] = !DIFile(filename: "vec-add-global-var.hip"
...
.Lfunc_begin0:
	.file	0 "/home/Luthier/vec-add" "vec-add-global-var.hip" md5 0x72ce27fa6e0f2ebee920b8498664306b
...
.Ltmp2:
	.file	2 "vec-add-global-var.hip"
	.loc	2 9 22                          ; vec-add-global-var.hip:9:22
	s_mul_i32 s2, s2, s3
	.loc	2 9 35 is_stmt 0                ; vec-add-global-var.hip:9:35
	v_add_u32_e32 v0, s2, v0
	.loc	2 10 9 is_stmt 1                ; vec-add-global-var.hip:10:9
...
.Ltmp4:
	.loc	2 10 37 discriminator 2         ; vec-add-global-var.hip:10:37
	v_ashrrev_i32_e32 v1, 31, v0
	v_lshlrev_b64 v[0:1], 2, v[0:1]
	.loc	2 10 21 is_stmt 0 discriminator 2 ; vec-add-global-var.hip:10:21
	s_getpc_b64 s[0:1]
	s_add_u32 s0, s0, global_const@rel32@lo+4
	s_addc_u32 s1, s1, global_const@rel32@hi+12
	.loc	2 10 37 discriminator 2         ; vec-add-global-var.hip:10:37
	s_waitcnt lgkmcnt(0)
	v_lshl_add_u64 v[2:3], s[4:5], 0, v[0:1]
	.loc	2 10 44 discriminator 2         ; vec-add-global-var.hip:10:44
	v_lshl_add_u64 v[4:5], s[6:7], 0, v[0:1]
	.loc	2 10 37 discriminator 2         ; vec-add-global-var.hip:10:37
	global_load_dword v6, v[2:3], off
	.loc	2 10 44 discriminator 2         ; vec-add-global-var.hip:10:44
	global_load_dword v7, v[4:5], off
	.loc	2 10 21 discriminator 2         ; vec-add-global-var.hip:10:21
	s_load_dword s0, s[0:1], 0x0
	.loc	2 10 14 discriminator 2         ; vec-add-global-var.hip:10:14
	v_lshl_add_u64 v[0:1], s[2:3], 0, v[0:1]
	.loc	2 10 21 discriminator 2         ; vec-add-global-var.hip:10:21
	s_waitcnt lgkmcnt(0)
	v_cvt_f32_i32_e32 v2, s0
	.loc	2 10 42 discriminator 2         ; vec-add-global-var.hip:10:42
	s_waitcnt vmcnt(0)
	v_add_f32_e32 v3, v6, v7
	.loc	2 10 34 discriminator 2         ; vec-add-global-var.hip:10:34
	v_mul_f32_e32 v2, v3, v2
	.loc	2 10 19 discriminator 2         ; vec-add-global-var.hip:10:19
	global_store_dword v[0:1], v2, off
.LBB0_2:
	.loc	2 11 1 is_stmt 1                ; vec-add-global-var.hip:11:1
	s_endpgm
.Ltmp5:
...
; COMPUTE_PGM_RSRC3_GFX90A:TG_SPLIT: 0
	...
	.text
	.protected	global_const            ; @global_const
...
global_const:
	...
	.type	__hip_cuid_959d67a1c26a6639,@object ; @__hip_cuid_959d67a1c26a6639
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_959d67a1c26a6639
__hip_cuid_959d67a1c26a6639:
	.byte	0                               ; 0x0
	.size	__hip_cuid_959d67a1c26a6639, 1
...
.Linfo_string1:
	.asciz	"vec-add-global-var.hip"        ; string offset=137
.Linfo_string2:
	.asciz	"/home/Luthier/vec-add"         ; string offset=160
.Linfo_string3:
	.asciz	"_ZL21__hip_get_block_dim_xv"   ; string offset=182
.Linfo_string4:
	.asciz	"__hip_get_block_dim_x"         ; string offset=210
.Linfo_string5:
	.asciz	"_ZN24__hip_builtin_blockDim_t7__get_xEv" ; string offset=232
.Linfo_string6:
	.asciz	"__get_x"                       ; string offset=272
.Linfo_string7:
	.asciz	"_ZL21__hip_get_block_idx_xv"   ; string offset=280
.Linfo_string8:
	.asciz	"__hip_get_block_idx_x"         ; string offset=308
.Linfo_string9:
	.asciz	"_ZN24__hip_builtin_blockIdx_t7__get_xEv" ; string offset=330
.Linfo_string10:
	.asciz	"_Z6vecAddPKfS0_Pfi"            ; string offset=370
.Linfo_string11:
	.asciz	"vecAdd"                        ; string offset=389
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
...
.Ldebug_addr_end0:
	...
	.addrsig
	.addrsig_sym global_const
	.addrsig_sym __hip_cuid_959d67a1c26a6639
	.amdgpu_metadata
---
amdhsa.kernels:
  - .agpr_count:     0
