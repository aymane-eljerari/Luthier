...
// zero for `(GetNamedOperand $vaddr)` in OFFSET-variant semantics. Must lift
// without translator assertion.

// CHECK: define {{.*}} @mubuf_offset
...
// CHECK-DAG: call {{.*}} @llvm.amdgcn.struct.buffer.store
  ...
  .globl  mubuf_offset
  .p2align  8
  .type   mubuf_offset,@function
mubuf_offset:
  buffer_load_dword v0, off, s[0:3], 0 offset:0
  s_waitcnt vmcnt(0)
  v_add_u32_e32 v0, 1, v0
  buffer_store_dword v0, off, s[0:3], 0 offset:0
  s_endpgm
