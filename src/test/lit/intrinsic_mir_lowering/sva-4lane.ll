...
; Four distinct readlane sites, followed by a REG_SEQUENCE merge into
; SGPR_128. Source order matches MIR emission order so use plain CHECKs.
; CHECK-COUNT-4: V_READLANE_B32 %{{[0-9]+}}, {{[0-9]+}}
